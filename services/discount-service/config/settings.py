"""
Django settings for discount service.
"""
...
SECRET_KEY = 'django-insecure-discount-service-key-change-in-production'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DATABASE_NAME', '/app/db/discount.db'),
